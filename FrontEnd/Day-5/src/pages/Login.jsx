                            ...
                            <div className="text-slider">
                                <div className="text-wrap">
                                    <div className="text-group">
                                        <h2 className={currmenu === 1 ? 'active-text':''}>Chess is a war of ideas.</h2>
                                        <h2 className={currmenu === 2 ? 'active-text':''}>Chess? Queen's the real flex.</h2>
                                        <h2 className={currmenu === 3 ? 'active-text':''}>1286+ Pawned. Checkmate coming!</h2>
                                    </div>
                                </div>
